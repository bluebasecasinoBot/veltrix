import {__sS , __SYD , __c, __p , __u , __g , __sC, __v} from "../sydneyDom_v3.js"
...
__SYD.verify_agent = () =>{
    return __c(
        "div",
        {
            style:`cursor:pointer;background:#03cefc;display:flex;text-decoration:none;min-width:fit-content;width:fit-content;gap:20px;align-items:center;padding:15px 30px;color: #000000 ;border-radius:7px;justify-content:space-between;${__p(["fetchAgent" , "verifyingAgent"],false) ? "pointer-events:none;opacity:.4;" : ""}`,
            // class:"launch_btn"
        },
        [
            __c(
