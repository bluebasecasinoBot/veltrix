    ...
    return __c(
        ...
        [
            __c(
                "h2",
                {
                    style:"font-size:18px;color: #03cefc ;font-weight:500;text-transform:capitalize;margin-bottom:16px;position:absolute;left:50%;transform:translateX(-50%);top:20px;font-family:shine;text-shadow:2px 2px 1px #141414;text-align:center;width:100%;pointer-events:none;opacity:1;"
                },
                [
        ...
        rectifiedMsg.forEach((val) =>{
            el.push(
                __c(
                    "p",
                    {
                        style:"font-family:monospace;font-weight:500;font-size:16px;margin-bottom:6px;"
                    },
                    [
                        `${val}`
                    ]
